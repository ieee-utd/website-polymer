...
class CommitteesPage extends PolymerElement {
  ...
  connectedCallback() {
    ...
    Tabletop.init( { key: 'https://docs.google.com/spreadsheets/d/18k69-NZcpUhzbuw0OVTmYuCDFZxnfSK8l-rSgYNBzAQ/pubhtml',
