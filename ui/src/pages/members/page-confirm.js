...
class PageMemberConfirm extends BaseElement {
  static get template() {
    return html`
      ...
      <form-button on-click="_confirm" label="Activate account" large id="confirmButton"></form-button>
    `;
  }
  ...
  _confirm() {
    ...
    .then(() => {
      ...
      this._showToast("Account confirmed! Please login with the password you created.")
...
window.customElements.define('page-confirm', PageMemberConfirm);
